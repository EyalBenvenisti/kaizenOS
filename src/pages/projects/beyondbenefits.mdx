...
### The challange
My position on the team was to research and design a well-being platform. One that is not (another) vendor management systems, not employee management, not even an e-commerce.

This is an intermediate platform to integrate Calander, ERP, and other communication tools.

My approach was to create the product narrative throughout the corporate well-being environment research. Moreover, I was the company's ears and eyes spending my days with clients.


**End goal**: To produce an MVP
...
I questioned some of my colleagues who work at Facebook and Google to get more meaning of successful corporate well-being.

>  found they own internal services, no exceptions. The big league has employees programs, which means our market should support the  500-1500 user base companies
...
Resources:
- [Dashoard flow ](https://www.figma.com/file/KTGXIQRkrUiJcXSkl02VmW/Beyond-Benefits-Main-Wireframes?node-id=0%3A12034) (More tabs on the left)
